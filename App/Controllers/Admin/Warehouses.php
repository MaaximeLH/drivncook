...
class Warehouses extends Controller
{
    ...
    public function warehousesAction()
    {
        ...
        return View::render('Admin/warehouses', ['admin' => $this->admin, 'page' => 'warehouses', 'warehouses' => $warehouses]);
    }
    ...
    public function supplyAction()
    {
        ...
        return View::render('Admin/supply', ['admin' => $this->admin, 'warehouse' => $warehouse, 'product' => $product, 'page' => 'warehouses', 'products' => $allProducts]);
    }
    ...
    public function supplyStepTwo()
    {
        ...
        return View::render('Admin/supplyStepTwo', ['admin' => $this->admin, 'page' => 'warehouses', 'warehouse' => $warehouse, 'products' => $products]);
    }
    ...
    public function addWarehousesAction()
    {
        ...
        if (Request::isPost()) {
            ...
            if (!empty($fields)) {
                return View::render('Admin/addWarehouses', ['admin' => $this->admin, 'page' => 'add_warehouses', 'fields' => $fields, 'params' => $params]);
            }
        ...
        return View::render('Admin/addWarehouses', ['admin' => $this->admin, 'page' => 'add_warehouses']);
    }
